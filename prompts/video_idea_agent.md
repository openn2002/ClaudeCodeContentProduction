...
- **Naming convention.** Never use "CSIRO" alone when referring to the program or its people — this is ambiguous and could mean the research organisation. Use "CSIRO TWD" as the shorthand for the program, and "CSIRO TWD Dietitian" when referring to the team. Only use "CSIRO" alone when referring to the research institution itself (e.g. "backed by CSIRO research"). This applies to idea titles, hooks, and all copy.
